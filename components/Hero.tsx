        ...
        <div className="relative mb-8 group mt-8 md:mt-0">
            ...
            */}
            <img 
              src="/profile.jpg" 
              alt="Raj Hansh" 
              className="relative w-32 h-32 md:w-40 md:h-40 rounded-full object-cover object-center border-2 border-cyber-dark ring-2 ring-cyber-green/50 shadow-2xl bg-cyber-gray"
              onError={(e) => {
